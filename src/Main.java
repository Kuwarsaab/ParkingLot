...
public class Main {
    public static void main(String[] args) {
        ...
        parkingLot.configureCostStrategy(Map.of(
                Vehicle.VehicleType.CAR, 10.0,
                Vehicle.VehicleType.SPORTSCAR, 10.0,
                Vehicle.VehicleType.BUS, 30.0,
                Vehicle.VehicleType.TRUCK, 30.0
        ), "INR");

        String token1 = parkingLot.addVehicle(new Vehicle("KA-01-AA-1111", "Red", Vehicle.VehicleType.SPORTSCAR));
        String token2 = parkingLot.addVehicle(new Vehicle("KA-01-BB-2222", "Blue", Vehicle.VehicleType.TRUCK));
